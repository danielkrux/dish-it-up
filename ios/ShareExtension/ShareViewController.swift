...
class ShareViewController: UIViewController {
    ...
    let hostAppURLScheme = "dish-it-up"
    ...
    private func redirectToHostApp(sharedURL: String) {
        ...
        var shareUrlEncoded = sharedURL.addingPercentEncoding(withAllowedCharacters: .urlHostAllowed)
        urlComponents.scheme = hostAppURLScheme
        urlComponents.queryItems = [
            URLQueryItem(name: "url", value: shareUrlEncoded),
        ]
